...
using Tataiee.Harif.WpfApplication.Data.Curriculum.Curriculums;
...
using Tataiee.Harif.WpfApplication.Layers.StudentHistory;
...
namespace Tataiee.Harif.WpfApplication.Layers.ReductionSteps
{
    public class ReductionStep1
    {
        ...
        {
            MainCurriculumSateValidator.PopulateSatelliteInformation(curriculum, satList, new List<int>());
            //PopulateSatelliteInformationHelper(curriculum.Root, satList, curriculum);
        }

        //remove this method end of the project beacuase never use and all it text are commented
        private static void PopulateSatelliteInformationHelper(CourseCategory courseCategory, List<SatelliteInformation> satList, MainCurriculum curriculum)
        {
            /*
            ...
            else
            {
                courseCategory.OutputGates.ForEach(og =>
                {
                    ...
                    {
                        //first calc
                        PopulateSatelliteInformationHelper(courseCategoryChild, satList, curriculum);
