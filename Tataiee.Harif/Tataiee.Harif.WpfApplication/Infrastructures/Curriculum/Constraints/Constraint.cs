...
namespace Tataiee.Harif.Infrastructures.Curriculum.Constraints
{
    public abstract class Constraint /*: IConstraint*/
    {
        public int Id { get; set; }

        //exactly satisfied? (bounderies)
    ...
    public class MinNumberMaxNumberOfCoursesConstraint : Constraint
    {
        ...
        public override bool IsOk(int x) =>  x <= MaxNumberOfCoursesMustBePass;
    ...
    public class MinUnitsMaxUnitsOfCoursesConstraint : Constraint
    {
        ...
        public override bool IsOk(int x) => x <= MaxUnitsOfCoursesMustBePass;
